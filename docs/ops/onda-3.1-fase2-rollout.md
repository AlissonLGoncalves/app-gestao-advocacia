...
> Em ambiente novo criado do zero apos a Fase 1, este runbook NAO e
> necessario — `release_command` cria as tabelas como `app_admin`,
> ownership ja fica correto e `flask db upgrade` aplica a Fase 2 sem
> ajustes.
...
## Passo 1 - Transferir ownership das 17 tabelas
...
A saida deve listar as 17 tabelas com `tableowner = app_admin`. Se
alguma aparecer como `postgres`, a transacao falhou — investigue antes
de prosseguir.
...
| Data       | Ambiente | Notas                                                                 |
|------------|----------|-----------------------------------------------------------------------|
| 2026-04-26 | prod     | Aplicado manualmente apos release_command da Fase 2 falhar (issue #102) |
