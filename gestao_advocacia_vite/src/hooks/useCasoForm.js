...
function useCasoForm({ formData, isEditing, casoParaEditar, onCasoChange, criarEvento, eventoData, setLoading }) {
  ...
  const criarEventoAgenda = useCallback(async (casoId, token) => {
  ...
  }, [casoParaEditar, clearValidationErrors, criarEvento, criarEventoAgenda, formData, isEditing, onCasoChange, setLoading, validateForm]);
