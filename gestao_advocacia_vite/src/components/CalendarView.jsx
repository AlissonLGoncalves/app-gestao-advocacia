...
function CalendarView() {
    ...
    try {
      ...
      const formattedEvents = (data.eventos || []).map((evento) => {
        ...
        return {
          ...
          allDay: allDayEvent,
          extendedProps: {
            // Para guardar dados extras do evento
  ...
  return (
    <div className="p-1 bg-white rounded shadow-sm">
      {' '}
      {/* Adiciona um pouco de padding e estilo ao container */}
      <FullCalendar
        ...
        buttonText={{
          // Traduz os botões, se o locale não o fizer completamente
          today: 'Hoje',
          month: 'Mês',
          week: 'Semana',
          day: 'Dia',
