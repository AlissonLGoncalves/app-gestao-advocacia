...
def register_despesas_routes(app, despesas_ns, despesa_input_model_dto, despesa_model_dto, finance_access_required):
    @despesas_ns.route('/')
    class DespesaListAPI(Resource):
        ...
        def post(self):
            ...
            nova_despesa = Despesa(
                descricao=data['descricao'], valor=valor_decimal, data_despesa=data_despesa_obj,
                pago=data.get('pago', False), caso_id=caso_id_val, user_id=user_id, tenant_id=get_tenant_id()
            )
