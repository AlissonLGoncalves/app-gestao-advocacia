...
from routes.casos_busca import register_casos_busca_routes
from services.caso_service import (
    normalizar_data_yyyy_mm_dd as _normalizar_data_yyyy_mm_dd,
)
from services.caso_service import (
    preencher_caso_from_data as _preencher_caso_from_data,
)
from services.caso_service import (
    vincular_pendentes_djen_ao_caso as _vincular_pendentes_djen_ao_caso,
)
...
def register_casos_routes(
    ...
    # #300 parte 4: rotas de busca/importacao CNJ vivem em casos_busca.py
    register_casos_busca_routes(app, casos_ns)
