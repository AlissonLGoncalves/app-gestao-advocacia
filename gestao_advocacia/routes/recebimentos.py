...
def register_recebimentos_routes(app, recebimentos_ns, recebimento_input_model_dto, recebimento_model_dto, finance_access_required):
    ...
    class RecebimentoListAPI(Resource):
        ...
        def post(self):
            ...
            novo_recebimento = Recebimento(
                descricao=data['descricao'], valor=valor_decimal, data_recebimento=data_recebimento_obj,
