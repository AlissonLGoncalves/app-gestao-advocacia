...
if not os.path.exists(db_path):
    ...
    if not tenant:
        ...
        cur.execute("INSERT INTO tenant (id, nome, cnpj, email_admin) VALUES (1, 'Escritório Fundamental', '00000', 'admin@admin.com')")
        conn.commit()
        tenant_id = 1
    else:
        tenant_id = tenant[0]
    ...
    tables = ['user', 'cliente', 'caso', 'despesa', 'recebimento', 'documento', 'evento_agenda', 'contrato_honorario']
    for table in tables:
        try:
